...
namespace CareerExplorer.Infrastructure.Migrations
{
    ...
    [Migration("20230508221531_removedUnusedTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.MeetingNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AppUserChat", b =>
                {
                    b.HasOne("CareerExplorer.Core.Entities.Chat", null)
                        .WithMany()
                        .HasForeignKey("ChatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CareerExplorer.Core.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.City", b =>
                {
                    b.HasOne("CareerExplorer.Core.Entities.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.JobSeeker", b =>
                {
                    b.HasOne("CareerExplorer.Core.Entities.City", "City")
                        .WithMany("JobSeekers")
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.Message", b =>
                {
                    b.HasOne("CareerExplorer.Core.Entities.Chat", "Chat")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("CareerExplorer.Core.Entities.RefreshToken", b =>
                {
                    b.HasOne("CareerExplorer.Core.Entities.AppUser", "AppUser")
                        .WithMany()
